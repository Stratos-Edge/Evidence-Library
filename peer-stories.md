# Library A — Peer Stories

Named-company AI transformation stories. Qualitative evidence for the FlightPlan transformation narrative. See `README.md` for disciplines (credibility tiering, currency, no-fabrication, de-duplication).

## Tags

Each entry is tagged so a FlightPlan can pull the relevant subset:

- **Vertical / operating model** — e.g. `precision-contract-manufacturing`, `med-surg-hospital`, or `cross-vertical` for general leadership stories.
- **Function** — the operational area the story is about (procurement, quality, customer service, enterprise-wide, etc.).
- **Company size** — small / mid-market / enterprise.
- **AI work type** — agentic automation, enterprise search, document AI, machine-data analytics, operating-model redesign, etc.
- **Story type** — process win / operating-model shift / new-revenue / scaling / leadership.

## Entry template

```
### [PS-NN] — [Company name or characterization]
- **Tags:** vertical · function · size · AI work type · story type
- **What they did:** [one or two sentences]
- **What changed:** [the outcome — qualitative, with quantitative detail where available]
- **Quote:** "[verbatim]" — [speaker, title, company]
- **Primary source:** [original publication / report / author] · [URL] · [date] — what the FlightPlan cites
...
_Seeded 2026-05-18 by the initial research pass — 20 verified stories (3 Tier 1, 17 Tier 3). `/start` adds to this every run; add your own using the template above or via `inbox/`. Seed entries use the prior single-source format; they carry the same information and move to the source-chain block on their next verification pass._

### [PS-01] — Acutec Precision Aerospace
- **Tags:** precision-contract-manufacturing (aerospace) · quoting/estimating · mid-market · document AI / requirements extraction · process win
- **What they did:** Adopted Paperless Parts' Wingman AI "Requirements Review," which scans RFQ packages — prints, models, emails — and surfaces critical, easy-to-miss requirements before they reach the shop floor.
- **What changed:** Estimators catch problem areas earlier in the quote cycle, reducing costly downstream mistakes on aerospace parts; quoting becomes more consistent.
- **Quote:** "Requirements Review helps us identify potential problem areas early, before they become costly mistakes." — Shawn Cerne, Acutec Precision Aerospace
- **Source:** Paperless Parts press release · https://www.paperlessparts.com/press/paperless-parts-new-ai-features-surface-critical-requirements-helping-shops-quote-faster-with-confidence/ · 2025-09-08
- **Credibility:** Tier 3 — vendor-reported case study
- **Added:** 2026-05-18 · **Last verified:** 2026-05-18

### [PS-02] — Reata Engineering & Machine Works
- **Tags:** precision-contract-manufacturing (aerospace/medical) · quoting/estimating · mid-market · document AI / geometry interpretation · process win
- **What they did:** Used Paperless Parts' AI-powered BOM Builder to quote complex multi-part assemblies by interpreting CAD geometry rather than manually pricing each component.
- **What changed:** A 32-part assembly that previously took an entire day now takes about five minutes; the lead estimator projects a 1,000-part assembly that historically took 2–3 weeks could be quoted in under a day.
- **Quote:** "Before the BOM Builder, quoting a complex assembly could take an entire day or even weeks." — Tawny Bush, Lead Estimator, Reata Engineering & Machine Works
- **Source:** Paperless Parts press release · https://www.paperlessparts.com/press/paperless-parts-announces-general-availability-of-bom-builder-to-accelerate-quoting-complex-assemblies/ · 2025-04-15
- **Credibility:** Tier 3 — vendor-reported case study
- **Added:** 2026-05-18 · **Last verified:** 2026-05-18

### [PS-03] — Harris Manufacturing Supply & Co.
- **Tags:** precision-contract-manufacturing (CNC machining) · quoting/estimating + margin analytics · small/mid-market · quote automation · scaling
- **What they did:** A family-owned CNC machine shop (founded 1948) implemented Paperless Parts to automate quoting and expose profitability by job and by machine.
- **What changed:** Quote response time improved roughly 99% (about a week down to a day); quote throughput rose 5x — turning quoting from a bottleneck into a growth lever.
- **Quote:** "It was taking us up to a week to return a quote." — Haley Barnes, Vice President, Harris Manufacturing Supply & Co.
- **Source:** Paperless Parts case study · https://www.paperlessparts.com/case-studies/harris-manufacturing-doubles-quote-turnaround-speed-reveals-critical-profit-margin-insights/ · date not stated
- **Credibility:** Tier 3 — vendor-reported case study
- **Added:** 2026-05-18 · **Last verified:** 2026-05-18

### [PS-04] — CAMM Metals, Inc.
- **Tags:** precision-contract-manufacturing (metal fabrication/machining) · quoting/estimating · small/mid-market · quote automation + manufacturability AI · operating-model shift
- **What they did:** A custom metal fabrication and machining job shop integrated Paperless Parts with its JobBOSS ERP, using AI manufacturability scanning and automated quote generation.
- **What changed:** Quoting time fell ~50% (15–20 min to ~7.5–10 min per job); the owner-estimator recovered ~20 hours per week, redirecting it from administrative quoting to team development and strategy.
- **Quote:** "Getting a quote out quickly is often the deciding factor in winning an order, and being able to get quotes out twice as fast now is a significant advantage." — Matt Soucie, President, CAMM Metals
- **Source:** Paperless Parts case study · https://www.paperlessparts.com/case-studies/camm-metals-inc-quotes-twice-as-fast-anticipates-growth-after-getting-up-running-with-paperless-parts-in-8-weeks/ · references Dec 2022 implementation
- **Credibility:** Tier 3 — vendor-reported case study
- **Added:** 2026-05-18 · **Last verified:** 2026-05-18

### [PS-05] — Dairy Conveyor Corporation
- **Tags:** mid-market industrial manufacturer (custom equipment) · engineering/procurement · mid-market · enterprise search / drawing-data AI · process win
- **What they did:** Deployed the CADDi AI Data Platform to index tens of thousands of engineering drawings, purchasing records, and historical design data scattered across folders and systems.
- **What changed:** Over a year, recovered roughly 600 hours by cutting workflow time on routine drawing-and-procurement tasks by more than 80%, making prior designs and supplier/cost data instantly searchable.
- **Quote:** _Omitted — no verbatim leadership quote verified from an accessible source._
- **Source:** BusinessWire · https://www.businesswire.com/news/home/20260203417131/en/Dairy-Conveyor-Corporation-Recovers-600-Hours-Through-a-Year-of-Optimizing-Daily-Tasks-With-the-CADDi-AI-Data-Platform · 2026-02-03
- **Credibility:** Tier 3 — vendor-reported (CADDi press release)
- **Added:** 2026-05-18 · **Last verified:** 2026-05-18

### [PS-06] — High-precision metal & plastic products manufacturer (unnamed in source)
- **Tags:** precision-contract-manufacturing · quoting/estimating · mid-market · enterprise search / drawing-data AI · process win
- **What they did:** A precision manufacturer of metal and plastic products used CADDi's AI data platform to search historical drawings and cost data when preparing new quotes.
- **What changed:** Quoting-related search time dropped from ~30 minutes to one or two minutes — a 96% reduction — letting estimators reuse prior pricing and design history.
- **Quote:** _Omitted — source characterizes the customer without naming a leader._
- **Source:** CADDi · https://us.caddi.com/resources/news/caddi-enables-a-leading-manufacturer-of-high-precision-metal-and-plastic-products-to-decrease-quoting-time-by-96 · 2026-01-27
- **Credibility:** Tier 3 — vendor-reported case study
- **Added:** 2026-05-18 · **Last verified:** 2026-05-18

### [PS-07] — Bosch (manufacturing plants)
- **Tags:** enterprise industrial manufacturer · shop-floor operations / maintenance · enterprise · agentic AI · operating-model shift
- **What they did:** Built the "Shopfloor Agent," an agentic AI that independently diagnoses machine errors, develops problem-solving strategies, and guides operators — including non-experts — through fixes; deployed at its Bamberg plant from late 2025.
- **What changed:** Machine failures can be resolved up to ten times faster; Bosch estimates roughly €850,000 in annual savings per plant from reduced downtime.
- **Quote:** "Every operator in production must be empowered with this agentic AI to find and eliminate errors." — Philipp Glaser, Project Manager for Agentic AI in Manufacturing, Bosch
- **Source:** Bosch · https://www.bosch.com/stories/agentic-ai-manufacturing-production/ · Bosch Annual Report 2025
- **Credibility:** Tier 3 — vendor-reported (company's own story)
- **Added:** 2026-05-18 · **Last verified:** 2026-05-18

### [PS-08] — Siemens (Electronics Factory Erlangen)
- **Tags:** enterprise industrial manufacturer · machine operations / maintenance · enterprise · generative AI copilot · process win
- **What they did:** Deployed the Siemens Industrial Copilot for Operations across soldering machines at its Erlangen electronics factory, translating machine error codes into natural language and recommending fixes from manuals and spare-parts lists.
- **What changed:** Reduced machine downtime, faster resolution of production bottlenecks, smoother shift handovers; the Industrial Copilot won the Hermes Award 2025 at Hannover Messe.
- **Quote:** "With the Siemens Industrial Copilot, we enable our customers to become sustainable digital enterprises." — Rainer Brehm, CEO Factory Automation, Siemens Digital Industries
- **Source:** Siemens Blog · https://blog.siemens.com/2025/03/innovative-problem-solver-for-the-challenges-of-tomorrow-a-siemens-industrial-copilot-at-the-electronics-factory-erlangen/ · 2025-03
- **Credibility:** Tier 3 — vendor-reported (company's own blog)
- **Added:** 2026-05-18 · **Last verified:** 2026-05-18

### [PS-09] — Dow
- **Tags:** enterprise manufacturer (chemicals) · supply chain / finance · enterprise · agentic AI / document AI · process win
- **What they did:** Built an autonomous agent in Microsoft Copilot Studio to scan the 100,000+ shipping-invoice PDFs Dow receives each year, flag billing inaccuracies, and surface them in a dashboard for employee review.
- **What changed:** Hidden billing losses that previously took weeks or months to find are now identified within minutes; Dow expects to save millions on shipping costs in the first year.
- **Quote:** _Omitted — source does not attribute a verbatim quote to a named Dow leader._
- **Source:** Official Microsoft Blog · https://blogs.microsoft.com/blog/2025/04/28/how-agentic-ai-is-driving-ai-first-business-transformation-for-customers-to-achieve-more/ · 2025-04-28
- **Credibility:** Tier 3 — vendor-reported (Microsoft customer story)
- **Added:** 2026-05-18 · **Last verified:** 2026-05-18

### [PS-10] — Husqvarna
- **Tags:** enterprise industrial manufacturer (outdoor power equipment) · quality / shop-floor support · enterprise · computer vision + AI chatbots · scaling
- **What they did:** Used Azure IoT Operations and AI tooling for a digital-factory program, deploying an "AI Vision Companion" for quality control and AI chatbots for shop-floor troubleshooting.
- **What changed:** Expected to roughly double connected devices and scale Azure IoT Operations from 2 factories to 40 — a point deployment turned into a fleet-wide operating capability.
- **Quote:** _Omitted — source does not include a named-leader quote for Husqvarna._
- **Source:** Microsoft Cloud Blog · https://www.microsoft.com/en-us/microsoft-cloud/blog/manufacturing/2025/03/25/industrial-ai-in-action-how-ai-agents-and-digital-threads-will-transform-the-manufacturing-industries/ · 2025-03-25
- **Credibility:** Tier 3 — vendor-reported (Microsoft customer story)
- **Added:** 2026-05-18 · **Last verified:** 2026-05-18

### [PS-11] — The Kraft Heinz Company
- **Tags:** enterprise manufacturer (consumer foods) · manufacturing operations / knowledge capture · enterprise · agentic AI / institutional-knowledge AI · operating-model shift
- **What they did:** Built "The Cookbook," a proprietary AI agent on Azure OpenAI trained on a database codifying decades of institutional production know-how; also runs a "Lighthouse" supply-chain control tower.
- **What changed:** Improved production consistency, quality, and efficiency; reduced manufacturing waste; shortened brand-asset creation timelines — part of a push toward an autonomous hybrid cloud/edge manufacturing model.
- **Quote:** "Our collaboration with Microsoft has been an important part of our digital transformation, helping us drive innovation and efficiencies through machine learning and advanced analytics so we can get products into the market faster." — Oliver Ganschar, Head of Digital Product Management and Innovation, Kraft Heinz
- **Source:** Microsoft Cloud Blog · https://www.microsoft.com/en-us/microsoft-cloud/blog/2025/11/20/from-legacy-to-frontier-how-100-year-brands-are-leading-ai-innovation/ · 2025-11-20
- **Credibility:** Tier 3 — vendor-reported (Microsoft customer story)
- **Added:** 2026-05-18 · **Last verified:** 2026-05-18

### [PS-12] — Land O'Lakes
- **Tags:** enterprise (agricultural cooperative) · field/advisory operations · enterprise · domain-expert AI assistant · operating-model shift
- **What they did:** Migrated two-thirds of its IT environment to Azure and built "Oz," a digital assistant combining Microsoft AI with agronomy expertise, putting deep technical guidance into the hands of retail agronomists in the field.
- **What changed:** Agronomists shifted from flipping through reference books to technical discussions with the AI, enabling faster, data-informed crop recommendations at the farm gate.
- **Quote:** "The idea has always been to make that agronomist the hero at the farm gate. Instead of flipping through a book, now agronomists can have this deep technical discussion with the AI." — Teddy Bekele, SVP and Chief Technology Officer, Land O'Lakes
- **Source:** Microsoft Cloud Blog · https://www.microsoft.com/en-us/microsoft-cloud/blog/2025/11/20/from-legacy-to-frontier-how-100-year-brands-are-leading-ai-innovation/ · 2025-11-20
- **Credibility:** Tier 3 — vendor-reported (Microsoft customer story)
- **Added:** 2026-05-18 · **Last verified:** 2026-05-18

### [PS-13] — Fujitsu
- **Tags:** enterprise (IT services) · sales / proposals · enterprise · multi-agent generative AI · process win
- **What they did:** Built a multi-agent system on Azure AI Agent Service in which specialized agents handle data analysis, market research, and document creation to assemble entire sales proposal packages.
- **What changed:** Proposal production time fell by 67%, freeing sales teams to spend more time on customer relationships.
- **Quote:** _Omitted — source does not attribute a verbatim quote to a named Fujitsu leader._
- **Source:** Official Microsoft Blog · https://blogs.microsoft.com/blog/2025/04/28/how-agentic-ai-is-driving-ai-first-business-transformation-for-customers-to-achieve-more/ · 2025-04-28
- **Credibility:** Tier 3 — vendor-reported (Microsoft customer story)
- **Added:** 2026-05-18 · **Last verified:** 2026-05-18

### [PS-14] — Wells Fargo
- **Tags:** enterprise (banking) · frontline operations / knowledge access · enterprise · conversational AI agent · process win
- **What they did:** Built a Microsoft Teams–based AI agent giving branch staff guidance on ~1,700 internal procedures across ~4,000 branches; separately rolled Microsoft 365 Copilot to 30,000+ employees.
- **What changed:** ~75% of procedure searches now run through the agent, with response times cut from ~10 minutes to 30 seconds; Copilot saw a 92% active-usage rate among enabled employees.
- **Quote:** "It's really a proof point saying that not only did people want to use these products, but they were waiting for it and excited about it." — Ken Meyer, CIO for Enterprise Functions, Wells Fargo
- **Source:** Microsoft Cloud Blog · https://www.microsoft.com/en-us/microsoft-cloud/blog/2025/11/20/from-legacy-to-frontier-how-100-year-brands-are-leading-ai-innovation/ · 2025-11-20
- **Credibility:** Tier 3 — vendor-reported (Microsoft customer story)
- **Added:** 2026-05-18 · **Last verified:** 2026-05-18

### [PS-15] — Grupo Bimbo
- **Tags:** enterprise manufacturer (consumer foods/bakery) · cross-functional operations · enterprise · low-code AI agents / Center of Excellence · scaling
- **What they did:** Established a technology Center of Excellence on Microsoft Power Platform and Copilot Studio, producing ~7,000 apps, 18,000 automated processes, and 650 AI agents across the organization.
- **What changed:** Saved tens of millions of dollars annually in development costs and operational efficiencies — a scaled, repeatable operating capability rather than isolated pilots.
- **Quote:** _Omitted — source does not attribute a verbatim quote to a named Grupo Bimbo leader._
- **Source:** Official Microsoft Blog · https://blogs.microsoft.com/blog/2025/04/28/how-agentic-ai-is-driving-ai-first-business-transformation-for-customers-to-achieve-more/ · 2025-04-28
- **Credibility:** Tier 3 — vendor-reported (Microsoft customer story)
- **Added:** 2026-05-18 · **Last verified:** 2026-05-18

### [PS-16] — Cynergy Bank
- **Tags:** mid-market (banking) · contact center / back office · mid-market · GenAI agent-assist + workflow automation · operating-model shift
- **What they did:** Worked with HCLTech to digitize repeatable contact-centre and back-office workflows, integrating case management, voice analytics, and GenAI agent assistance so routine work is automated and staff freed for higher-value interactions.
- **What changed:** Complaints fell by over 50%, productivity rose 8%, customer experience scores rose 25% — described as a more effective operating model, not just a tool deployment.
- **Quote:** "They also provide the technology behind [our people] that can supercharge that relationship... bringing together technology and the right people to up-service [customer] needs." — Sharon Maguire, COO and Chief Product Officer, Cynergy Bank
- **Source:** HCLTech case study · https://www.hcltech.com/case-study/transforming-banking-operations · accessed 2026-05-18
- **Credibility:** Tier 3 — vendor-reported (HCLTech case study)
- **Added:** 2026-05-18 · **Last verified:** 2026-05-18

### [PS-17] — Klarna
- **Tags:** mid-market/scale-up (fintech) · customer service · mid-market · GenAI customer-service assistant · operating-model shift
- **What they did:** Deployed an OpenAI-powered customer-service assistant that took over the majority of incoming support chats.
- **What changed:** Handled ~two-thirds of support chats in its first month (~2.3M conversations), cut average resolution time from ~11 minutes to under 2, and was credited with ~$40M annual profit improvement — though in May 2025 the CEO acknowledged the full pivot produced "lower quality" work in places, a candid counterpoint worth carrying with the story.
- **Quote:** "To me, AI is capable of doing all our jobs, my own included." — Sebastian Siemiatkowski, CEO, Klarna
- **Source:** Fortune · https://fortune.com/article/klarna-ceo-feels-gloomy-ai-could-do-his-job/ · 2025
- **Credibility:** Tier 1 — independent press (Fortune); results figures originate with Klarna — treat those as company-reported
- **Added:** 2026-05-18 · **Last verified:** 2026-05-18

### [PS-18] — Moderna
- **Tags:** enterprise (biotech) · HR / org design · enterprise · custom GPTs / enterprise-wide AI · leadership
- **What they did:** Merged HR and IT under a single Chief People and Digital Technology Officer and deployed 3,000+ custom GPTs trained on internal data across legal, manufacturing, research, and HR — for ~5,800 employees.
- **What changed:** Shifted from static role planning to dynamic "work planning," with roles created, eliminated, and reimagined based on whether a human or machine is best suited — an explicit operating-model and leadership change.
- **Quote:** "I've shifted from workforce planning to work planning." — Tracey Franklin, Chief People and Digital Technology Officer, Moderna
- **Source:** FlexOS · https://www.flexos.work/learn/moderna-merges-hr-it-new-chief-manages-3000-ai-and-5800-humans · 2025-05-14
- **Credibility:** Tier 1 — independent press/analysis
- **Added:** 2026-05-18 · **Last verified:** 2026-05-18

### [PS-19] — Procter & Gamble
- **Tags:** enterprise (consumer goods) · R&D / new product development · enterprise · generative AI as collaborator · leadership
- **What they did:** Ran a controlled study (with Harvard, Wharton, ESSEC) of 776 employees doing real product-development work alone or in teams, with and without GPT-4, to test how AI changes how the organization innovates.
- **What changed:** AI-assisted individuals outperformed unaided two-person teams and worked 12–16% faster; teams with AI produced significantly more "exceptional" ideas; AI broke down silos between R&D and commercial functions, letting junior staff perform near expert level.
- **Quote:** "AI serves not just as an information provider but as an effective boundary-spanning mechanism, helping professionals reason across traditional domain boundaries." — Ethan Mollick, Wharton (study co-author)
- **Source:** Fortune · https://fortune.com/2025/03/25/ai-teamwork-study-collaboration-mollick-procter-gamble/ · 2025-03-25
- **Credibility:** Tier 1 — independent press reporting on an academic study
- **Added:** 2026-05-18 · **Last verified:** 2026-05-18

### [PS-20] — Estée Lauder Companies
- **Tags:** enterprise (consumer goods) · consumer insights / analytics · enterprise · agentic AI · process win
- **What they did:** Built "ConsumerIQ," an agent in Microsoft Copilot Studio that centralizes and analyzes consumer data across the company.
- **What changed:** Reduced data-gathering time from hours to seconds, accelerating decision-making for product and marketing teams.
- **Quote:** _Omitted — source does not attribute a verbatim quote to a named Estée Lauder leader._
- **Source:** Official Microsoft Blog · https://blogs.microsoft.com/blog/2025/04/28/how-agentic-ai-is-driving-ai-first-business-transformation-for-customers-to-achieve-more/ · 2025-04-28
- **Credibility:** Tier 3 — vendor-reported (Microsoft customer story)
- **Added:** 2026-05-18 · **Last verified:** 2026-05-18
...
- **What they did:** Built and continuously iterated Erica, a conversational AI virtual assistant in its mobile app providing 24/7 financial insights, transaction search, and budgeting help to 40M+ clients since 2018.
- **What changed:** Cumulative client interactions surpassed 2.5 billion (the second billion came in just 18 months vs. four years for the first); ~2 million interactions a day; the data-science team has made 50,000+ updates to Erica since launch.
- **Quote:** "Erica acts as both a personal concierge and mission control for our clients… 2 billion client interactions is a compelling milestone though this is only the beginning." — Nikki Katz, Head of Digital, Bank of America
- **Primary source:** Bank of America Newsroom — "BofA's Erica Surpasses 2 Billion Interactions" · https://newsroom.bankofamerica.com/content/newsroom/press-releases/2024/04/bofa-s-erica-surpasses-2-billion-interactions--helping-42-millio.html · 2024-04-01
...
- **What they did:** Built DevGen.AI, an in-house tool on OpenAI GPT models (launched January 2025) that reverse-engineers legacy code — COBOL, Perl, firm-specific languages — into plain-English specifications so developers can rewrite it in modern languages.
- **What changed:** In its first five months DevGen.AI processed ~9 million lines of code and saved the firm's ~15,000 developers roughly 280,000 hours of work; Morgan Stanley rose from #10 to #5 in the Evident AI Index.
- **Quote:** "Building it ourselves gave us certain capabilities that we're not really seeing in some of the commercial products." — Mike Pizzi, Global Head of Technology and Operations, Morgan Stanley
- **Primary source:** Wall Street Journal reporting (June 2025), corroborated by Entrepreneur · https://www.entrepreneur.com/business-news/morgan-stanley-builds-ai-tool-that-fixes-major-coding-issue/492697 · 2025-06-03; compiled in Evident Insights "Evident AI Index: Banks" (Oct 2025)
...
- **What they did:** Rolled out the GS AI Assistant firm-wide in June 2025 (expanding beyond the ~10,000 knowledge workers who piloted it), launched a Legend AI query tool and an IPO-drafting tool, and adopted the autonomous coding agent Devin — part of a CEO-stated three-year efficiency program.
- **What changed:** Returned to the Evident AI Index top 10 (#9) with gains across Talent (+6 rank), Leadership (+9), and Transparency (+14); CIO Marco Argenti has said that within three years no Goldman employee will be untouched by AI.
- **Quote:** _Omitted — no verbatim leadership quote captured from an accessible primary source; "touched by AI" is the only attributable fragment._
- **Primary source:** Evident Insights — "Evident AI Index: Banks" · https://evidentinsights.com · October 2025 (relaying Goldman Sachs disclosures)
- **Found via:** "Banking AI Key-findings 2025" (Evident AI Index)
...
- **What they did:** Rolled out Athena (July 2025), its first large-scale GenAI product — an AI knowledge hub letting customer-service colleagues search the bank's 13,000 internal information articles in natural language.
- **What changed:** Average search time fell from 59 seconds to ~20 seconds (a 66% reduction); 21,000 colleagues ran 2.1 million searches in the first half of 2025; Lloyds estimates ~£50M in revenue growth and productivity gains in 2025 and rose from 27th to 15th in the Evident AI Index.
- **Quote:** "Athena is a monumental leap in our digital and strategic evolution, as we harness the power of generative AI to supercharge efficiency and elevate the customer experience." — Lloyds Banking Group
- **Primary source:** Lloyds Banking Group press release — "Group accelerates digital transformation with AI-powered Athena" · https://www.lloydsbankinggroup.com/media/press-releases/2025/lloyds-banking-group-2025/lloyds-accelerates-with-athena.html · 2025-07-15
- **Found via:** "Banking AI Key-findings 2025" (Evident AI Index)
...
- **What they did:** Built on customized open-source LLMs and launched Chat Concierge in early 2025 — described as the industry's first multi-agent AI tool for the car-buying experience, comparing vehicles, offering financing, estimating trade-in values, and scheduling test drives through dealer-system integration.
- **What changed:** Capital One's first customer-facing agentic deployment; the bank held industry-leading AI talent density (~6.7% of headcount) even after the Discover acquisition added ~21,000 employees, and ranks #2 in the Evident AI Index (#1 in Talent).
- **Quote:** _Omitted — no verbatim leadership quote captured from an accessible primary source._
- **Primary source:** Evident Insights — "Evident AI Index: Banks" · https://evidentinsights.com · October 2025 (relaying Capital One disclosures)
- **Found via:** "Banking AI Key-findings 2025" (Evident AI Index)
...
- **What they did:** A branchless digital bank that rolled out its proprietary Ally.ai platform enterprise-wide in July 2025 to 10,000+ employees, paired with mandatory GenAI risk-and-controls training and an internal "AI Fluency Hub"; was the first US bank to join the Responsible AI Institute.
- **What changed:** In Evident's first "shadow ranking" of challenger banks, Ally placed 21st of 54 — competitive head-to-head with top-20 global banks despite far smaller scale — strongest in Leadership and Talent.
- **Quote:** "People often believe AI leads to innovation. We actually approach it differently. The foundation starts with data… Technology shows us the art of the possible — but true innovation requires a multi-dimensional foundation." — Sathish Muthukrishnan, Chief Information, Data and Digital Officer, Ally Financial
- **Primary source:** Evident Insights — "Evident AI Index: Banks" · https://evidentinsights.com · October 2025 (interview conducted by Evident)
- **Found via:** "Banking AI Key-findings 2025" (Evident AI Index)
...
- **What they did:** Built a portfolio of 90+ AI use cases including the Schwab Knowledge Assistant, an employee-facing GenAI tool supporting client interactions.
- **What changed:** Reported 90% growth in employee AI use and time savings of up to two minutes per client interaction; the CEO credited AI with improving employee efficiency and lowering Schwab's cost per account over time; Schwab climbed 14 places in the Evident AI Index to #35.
- **Quote:** _Omitted — no verbatim leadership quote captured from an accessible primary source._
- **Primary source:** Evident Insights — "Evident AI Index: Banks" · https://evidentinsights.com · October 2025 (relaying Schwab investor disclosures)
- **Found via:** "Banking AI Key-findings 2025" (Evident AI Index)
...
- **What they did:** Partnered with the University of Navarra's data-science institute on a multi-year staff qualification program — including industrial doctorates and an official master's — and runs an internal "Data University."
- **What changed:** Over 50,000 employees have completed some form of data/AI training; ~5,000 received specialized instruction as data scientists, specialists, and engineers — building AI capability as an enterprise-wide competency.
- **Quote:** _Omitted — no verbatim leadership quote captured from an accessible primary source._
- **Primary source:** Evident Insights — "Evident AI Index: Banks" · https://evidentinsights.com · October 2025 (relaying BBVA disclosures)
- **Found via:** "Banking AI Key-findings 2025" (Evident AI Index)
...
- **What they did:** Launched its first agentic-AI use case (faster payment-dispute resolution) and "Project Coral," an agentic engineering framework that autonomously identifies and suggests fixes for technical debt across ~8,000 engineers; established a Seattle tech hub and a university AI research centre.
- **What changed:** Growing AI talent at roughly twice the rate of the overall Evident AI Index — faster than any bank except Capital One — and improved AI talent density by ~100 basis points; ranks #4 in the Index.
- **Quote:** _Omitted — no verbatim leadership quote captured from an accessible primary source._
- **Primary source:** Evident Insights — "Evident AI Index: Banks" · https://evidentinsights.com · October 2025 (relaying CommBank disclosures)
- **Found via:** "Banking AI Key-findings 2025" (Evident AI Index)
- **Credibility:** Tier 1 — independent intelligence firm
- **Verification:** primary accessed & confirmed 2026-05-18
- **Added:** 2026-05-18 · **Last verified:** 2026-05-18
...
- **What they did:** Evaluated 225+ AI solutions and selected 40 use cases to go live — including one of the largest deployments of Microsoft Dragon Copilot, imaging tools (Aidoc, Rad AI), and AI in call centers.
- **What changed:** The portfolio is projected to reduce documentation time by more than 50%, alongside automation of prior authorizations, referrals, and coding workflows.
- **Quote:** _Omitted — source does not attribute a verbatim quote to a named Advocate Health leader._
...
- **What they did:** Committed to investing more than $1B in AI over the next several years across 200+ projects spanning diagnostics, patient care, and administrative automation.
- **What changed:** No outcomes yet — this is a capital-commitment signal of how a leading academic health system is sizing its AI bet, not a results story.
- **Quote:** _Omitted — source does not attribute a verbatim quote to a named Mayo Clinic leader._
- **Primary source:** Menlo Ventures — "2025: The State of AI in Healthcare" · https://menlovc.com/perspective/2025-the-state-of-ai-in-healthcare/ · 2025-10-21
- **Found via:** "2025 The State of AI in Healthcare" (Menlo Ventures report)
...
- **What they did:** One of the largest independent US radiology groups; scaled from co-building with fewer than 10 AI vendors to piloting solutions from more than 50 — covering patient intake, ambient scribing, and revenue-cycle management.
- **What changed:** A shift in sourcing posture — from a few co-build partners to broad multi-vendor piloting — illustrating how a mid-sized provider widens its AI surface area.
- **Quote:** _Omitted — source does not attribute a verbatim quote to a named SimonMed leader._
- **Primary source:** Menlo Ventures — "2025: The State of AI in Healthcare" · https://menlovc.com/perspective/2025-the-state-of-ai-in-healthcare/ · 2025-10-21
- **Found via:** "2025 The State of AI in Healthcare" (Menlo Ventures report)
...
- **What they did:** Built an AI democratization program with Dataiku as the core platform — three-day data-and-AI hackathons on real business challenges, plus hands-on training where non-technical employees build their own ML models in hours.
- **What changed:** 270+ employees across 10 functions and factories trained (including 10 VPs who built their first model); 90% of hackathon participants identified practical new AI applications, 72% were inspired to keep developing data-science skills; 50+ use cases queued for production, three already delivered.
- **Quote:** "Our vision is to enable anyone in the organization with trusted and easy-to-use data products and analytics… now that we have Dataiku, we can very easily create a project and share it with different people." — Thierry Martin, Head of Data & Analytics, IT&D, Toyota Motor Europe
...
- **What they did:** Partnered with Squirro to build "Nautilus," an AI-powered semantic enterprise search hub for Henkel's technical and R&D community, unifying 45+ internal and external data sources enriched with Henkel's own taxonomy.
- **What changed:** Served 3,300 users, made 300k+ search results discoverable, and reached a 94% customer-satisfaction score — reducing duplicate analysis and speeding expert location across the technical community.
- **Quote:** "Squirro was onboarded to bring a state-of-the-art knowledge management system and help push the boundaries on how Henkel makes use of our data." — John Cocco, Senior Vice President, Henkel
- **Primary source:** Squirro — "Semantic Enterprise Search for Manufacturing" (Henkel case study) · https://squirro.com/semantic-enterprise-search-for-manufacturing · ~2024
...
- **What they did:** Co-developed (with Accenture) a generative-AI tool to produce marketing content, including short TV ads, with the aim of having ads ready for the 2026 holiday season.
- **What changed:** Expects the tool to cut marketing-content production costs by 30–50%; has invested more than $40M in it.
- **Quote:** _Omitted — Reuters paraphrases Mondelez's named executive (Jon Halvorson, SVP Consumer Experience); no verbatim quote captured._
- **Primary source:** Reuters — "Oreo-maker Mondelez to use new generative AI tool to slash marketing costs" · https://www.reuters.com · 2025-10-24
...
- **What they did:** Deployed AI-powered content creation across its brands under a "Desire at Scale" program, publishing several AI content case studies.
- **What changed:** Reports creating marketing assets up to 30% faster, with content doubling key engagement metrics (video completion rate, click-through rate) and improving TikTok visibility for brands such as Sunlight by 22.5%.
- **Quote:** _Omitted — source does not attribute a verbatim quote to a named Unilever leader._
- **Primary source:** Unilever — "How AI is helping drive Desire at Scale across Unilever" · https://www.unilever.com · 2025-09-30
- **Found via:** "2025 Autumn AI" (Benedict Evans deck), p. 70
...
- **What they did:** The CEO declared the company "AI-first" in an all-hands memo, replacing a slow manual content-creation process with an AI-powered one and folding AI use into hiring and performance reviews; headcount is granted only where a team cannot automate more of its work.
- **What changed:** A new chess curriculum was prototyped by a two-person team where neither could program nor play chess — built entirely with AI; the company frames AI as the only way to scale content to more learners at acceptable speed.
- **Quote:** "One of the best decisions we made recently was replacing a slow, manual content creation process with one powered by AI. Without AI, it would take us decades to scale our content to more learners." — Luis von Ahn, Co-Founder & CEO, Duolingo
- **Primary source:** Luis von Ahn / Duolingo all-hands memo, April 2025 (posted via LinkedIn), widely reported
...
- **What they did:** The CEO issued an internal memo making "reflexive AI usage" a baseline expectation for every employee — AI competency built into hiring criteria and performance/peer reviews, and teams required to justify why a task cannot be done with AI before requesting new headcount or resources.
- **What changed:** A structural operating-model change rather than a tool deployment — AI fluency became a formal evaluation and hiring criterion company-wide.
- **Quote:** "Reflexive AI usage is now a baseline expectation at Shopify… Stagnation is almost certain, and stagnation is slow-motion failure. If you're not climbing, you're sliding." — Tobias Lütke, Co-Founder & CEO, Shopify
- **Primary source:** Tobias Lütke internal memo, March 2025 (posted via X), corroborated by Inc. · https://www.inc.com/ben-sherry/shopify-ceo-to-employees-use-ai-now/91173063 · 2025-04-07
...
- **What they did:** Launched "Byte by Yum!" in February 2025 — an AI-powered restaurant-management platform that automates repetitive store tasks (inventory tracking, scheduling, food-prep alerts) and applies machine learning to restaurant-level decisions across KFC, Taco Bell, Pizza Hut, and The Habit.
- **What changed:** Restaurants using at least one Byte by Yum! product went from 0 to 25,000 within a year — though Yum! notes some underlying technologies were in use before the branded launch.
- **Quote:** "Backed by artificial intelligence, Byte by Yum! offers franchisees leading technology capabilities with advantaged economics made possible by the scale of Yum!." — Yum! Brands
- **Primary source:** Yum! Brands press release — "Introducing Byte by Yum!" · https://www.yum.com · 2025-02-06
...
- **What they did:** Launched the AI chatbot "Billie" (2021), which now handles ~47% of call-centre queries; rather than cutting the displaced staff, Ingka reskilled 8,500 call-centre co-workers across ~22 countries into remote interior-design advisors who run paid video design consultations — mood boards, floor plans, 3D renderings, curated product lists.
- **What changed:** The remote interior-design channel — staffed by the reskilled former call-centre workers — generated ~€1.3B (~$1.4B) in FY2022, 3.3% of Ingka's total revenue, a stream that was negligible before; Ingka set a target of 10% by 2028. No headcount reduction: asked whether AI would cut jobs, the company said "that's not what we're seeing right now."
- **What changed note:** A textbook case of agentic automation used to open a new revenue path rather than eliminate roles — the displaced capability (product knowledge, customer empathy) became the raw material for the higher-value role.
- **Quote:** "We're committed to strengthening co-workers' employability… through lifelong learning and development and reskilling, and to accelerate the creation of new jobs." — Ulrika Biesert, Global People & Culture Manager, Ingka Group
- **Primary source:** Reuters (June 2023), corroborated by Ingka Group newsroom — "AI and Remote Selling bring IKEA design expertise to the many" · https://www.ingka.com/newsroom/ai-and-remote-selling-bring-ikea-design-expertise-to-the-many/ · 2023
...
- **What they did:** Built an AI assistant on Google's Gemini — trained on ~15,000 internal documents — for its ~28,000-person customer-service team; the AI handles information lookups and on-screen guidance so reps shift from pure servicing to selling. Verizon described it as "reskilling in real time from customer care agents to selling agents," and positioned the move explicitly as augmentation, contrasting it with headcount-cutting peers.
- **What changed:** Sales through the customer-service team rose nearly 40% after the rollout (deployed July 2024, scaled January 2025); the AI also cut call times and improved answer quality, supporting a retention/churn objective.
- **Quote:** "We are doing reskilling in real time from customer care agents to selling agents." — Sampath Sowmyanarayan, CEO, Verizon Consumer Group
- **Primary source:** Reuters — "Verizon says Google AI for customer service agents has led to sales jump" · April 2025 · https://finance.yahoo.com/news/verizon-says-google-ai-customer-120648667.html (Reuters wire)
- **Found via:** research sweep, 2026-05-18 (operator request — workforce-redeployment examples)
...
- **What they did:** Deployed Agentforce on its help portal (early 2025), reaching a ~63% case-resolution rate; rather than cutting support engineers, redeployed hundreds into faster-growing parts of the business — including sales — matched through "Career Connect," an AI-powered internal talent marketplace that recommends roles from a person's skills and goals.
- **What changed:** Hundreds of support engineers — with deep product knowledge and customer-facing skills — moved into new roles, with hiring managers reporting them among their best hires; Salesforce's chief digital evangelist publicly cited ~3,000 employees added to the sales function without external hiring.
- **Quote:** _Omitted — the Salesforce newsroom account paraphrases rather than attributing a verbatim leadership quote to a named individual._
- **Primary source:** Salesforce — "How Salesforce Is Reshaping Its Workforce in the Age of AI" · https://www.salesforce.com/news/stories/salesforce-reshaping-workforce-in-age-of-ai/ · 2026-04-29
- **Found via:** research sweep, 2026-05-18 (operator request — workforce-redeployment examples)
...
- **What they did:** Intercom's "Fin" AI agent reached 83% automation of its own support volume and absorbed a 300% rise in support demand without matching headcount; instead of shrinking the team, Intercom created a consultative team for proactive, revenue-oriented engagement with self-serve customers and moved 40+ people from support into product, engineering, and sales.
- **What changed:** Support shifted from a cost centre to a contributor to adoption, retention, and revenue — and a "proving ground for talent"; ~100+ positions of headcount were avoided ($7.5–9M annualized cost avoidance) while new customer-access paths opened for trial users and website visitors.
- **Quote:** "We're not just responding to problems. We're proactively reaching out and providing consultative support to customers on how to get more from Fin. We're contributing to adoption, retention, and revenue." — Bobby Stapleton, Senior Director of Human Support, Intercom
- **Primary source:** Intercom / Fin — "How Fin's own support team reached 83% automation and rebuilt around AI" (customer story) · https://fin.ai/customers/fin-support-team · 2025
- **Found via:** research sweep, 2026-05-18 (operator request — workforce-redeployment examples)
...
- **What they did:** Under its "Next Gen Good Neighbor" / "Human + Digital" strategy, joined OpenAI's Frontier platform as a launch partner and is deploying AI across claims and agent operations (claims triage, a contact-centre knowledge assistant, the agent tool "Navi") on an explicit "augment, don't replace" rule for its 19,200+ agent offices and 62,000+ employees — while expanding its financial-services capabilities and investing in agents as financial professionals.
- **What changed:** AI is sequenced back-of-house first, to lift agent capacity rather than reduce the licensed-agent network; the strategic intent is to reposition agents from insurance-policy servicing toward financial and wealth advisory. State Farm operates as a mutual, serving 96M+ policies and accounts.
- **Quote:** "Our goal: strengthen the capabilities of State Farm agents and employees so they can provide best-in-class service to our customers." — State Farm, on the OpenAI collaboration
- **Primary source:** State Farm Newsroom — "State Farm Advances AI Vision Through Collaboration with OpenAI" (2026-02-05) and "Our Next Gen Good Neighbor Customer Experience" (2026-05-12) · https://newsroom.statefarm.com/state-farm-advances-ai-vision-through-collaboration-with-openai/
- **Found via:** research sweep, 2026-05-18 (operator request — workforce-redeployment examples)
...
- **What they did:** A leading US provider of in-home health care — home health, hospice, and personal care — running both office-based knowledge workers and a large mobile caregiver workforce (nurses, aides, therapists), deployed Glean's Work AI platform to free caregivers from documentation and administrative burden and to accelerate recruiting, onboarding, and retention. Pre-Glean, caregivers spent ~70% of their time on administrative duties.
- **What changed:** ~14–15% increase in nurse retention (the deck states 14%, noting ~$3.5K recruiting cost avoided per retained recruit; Glean's healthcare blog states 15% after 90 days of use); a 99% reduction in manual resume-parsing time (4 days → 4 minutes); and >39,000 minutes saved in the client journey to match clients to the right care.
- **Quote:** _Omitted — no verbatim leadership quote in an accessible source._
- **Primary source:** Glean — "How AI for healthcare providers improves operations" (blog, Stephanie Baladi) · https://www.glean.com/blog/ai-for-healthcare-providers · last updated 2026-05-18 — publicly carries the nurse-retention figure ("one home health provider improved nurse retention by 15% after using Glean for just 90 days")
...
- **Quote:** "In behavioral health, we are also leveraging AI features in an existing digital tool to streamline the referral and intake process to improve response times to new referrals and improve volumes." — Marc Miller, CEO, UHS (Feb 26, 2026 earnings call)
- **Primary source:** UHS Q4-2025 earnings call commentary, via Becker's Behavioral Health · https://www.beckersbehavioralhealth.com/ai-2/uhs-to-roll-out-behavioral-health-revenue-cycle-ai-tools-in-2026/ · 2026-03-02; UHS-Hippocratic AI announcement via Healthcare Dive · https://www.healthcaredive.com/news/uhs-partners-hippocratic-ai-launch-ai-agents/750892/ · 2025-06-17
...
- **Quote:** "The behavioral health industry is very ripe for automation and technology because it has traditionally been a paper-based, manual part of health care. Acadia Healthcare is committed to investing in technology to really focus on two things: our patients' experience and all our clinicians who are helping our patients." — Laura Groschen, CIO, Acadia Healthcare
- **Primary source:** Behavioral Health Business interview with CIO Laura Groschen · https://bhbusiness.com/2024/06/24/how-behavioral-health-leaders-acadia-lifestance-are-modernizing-their-digital-practices/ · 2024-06-24; Acadia turnaround SWOT · https://www.investing.com/news/swot-analysis/acadia-healthcares-swot-analysis-stock-navigates-turnaround-hopes-93CH-4707787 · 2025
- **Found via:** /start sweep for Perimeter Healthcare engagement, 2026-05-25
...
- **Quote:** "One appeal of [the Concord Connect platform] was the fax-streaming process. We could look at referrals as they were coming in, to make faster decisions." — Guy, Oceans Healthcare
- **Primary source:** Concord Technologies Oceans Healthcare case study · https://concord.net/case-studies/oceans-healthcare/ · 2025-04-04
- **Found via:** /start sweep for Perimeter Healthcare engagement, 2026-05-25
...
- **Quote:** "Referral management is where access to care begins in Human Services. We are automating not only the referral workflow but the entire process, from triaging referrals to eligibility verification, intake process and payment. By streamlining the referral process organizations can deliver the right level of care and optimize reimbursement." — AJ Peterson, SVP & GM of CareGuidance, Netsmart
- **Primary source:** OPEN MINDS / Netsmart joint webinar announcement and case write-up · https://openminds.com/press/open-minds-netsmart-announce-executive-webinar-from-referral-to-admission-how-automation-transforms-intake/ · 2026-03-15
- **Found via:** /start sweep for Perimeter Healthcare engagement, 2026-05-25
...
- **Quote:** "We know that documentation burden is a leading cause of clinician burnout. Over the last 12 months, we've trialled this technology across CNWL with promising results."
- **Primary source:** Central and North West London NHS Foundation Trust news · https://www.cnwl.nhs.uk/news/cahms-quality-improvement-project-using-ai-technology-wins-first-prize · 2024
- **Found via:** /start sweep for Perimeter Healthcare engagement, 2026-05-25
...
- **Primary source:** MobiHealthNews · https://www.mobihealthnews.com/news/seattle-childrens-hospital-implements-abridges-ai-platform-enterprise-wide · 2025-09-30
- **Found via:** /start sweep for Perimeter Healthcare engagement, 2026-05-25
...
- **Primary source:** The Latitude Group case study · https://latitude-group.com/case-studies/ai-enabled-admissions-automation-in-behavioral-healthcare-the-latitude-group/ · 2026-03-17
- **Found via:** /start sweep for Perimeter Healthcare engagement, 2026-05-25
...
- **Primary source:** Digital Health (UK) · https://www.digitalhealth.net/2026/05/rotherham-nhs-ft-cuts-it-help-desk-calls-by-28-with-ai/ · 2026-05-22
- **Found via:** /start sweep for Perimeter Healthcare engagement, 2026-05-25
...
- **Credibility skews Tier 3.** Named, quote-bearing manufacturing stories live overwhelmingly in vendor case studies (Paperless Parts, CADDi, Microsoft, HCLTech, Bosch, Siemens). Every one is labeled honestly. Only PS-17, PS-18, PS-19 are Tier 1; PS-19 is the strongest, resting on an academic study. A FlightPlan should lead with Tier 1 where the point allows and caption Tier 3 stories as company-reported.
- **Known gap.** Independent, Tier-1, quote-bearing stories specifically about *precision contract manufacturers* are genuinely scarce — that category is dominated by vendor content. Closing it needs paid analyst case files (Gartner/IDC manufacturing) or facilitator-sourced references; flag this when the transformation narrative leans on precision-CM peers.
- **Quotes omitted where unverifiable** (PS-05, 06, 09, 10, 13, 15, 20) rather than invented — same non-fabrication rule as everywhere else.
- The `/start` every-run sweep should prioritize filling the Tier-1 precision-CM gap and refreshing as independent case studies are published.

### Notes on the 2026-05-18 inbox batch (PS-21–PS-41)

- **21 stories added**, weighted to the FlightPlan's target verticals: financial services (PS-22–31, banking — anchored by the independent Evident AI Index) and healthcare (PS-21, 32–34). PS-35/36 are manufacturing knowledge-work stories; PS-37–41 are cross-vertical operating-model and content-production stories.
