...
### [PG-125] — Handing individuals an AI tool changes the *texture* of work, not its *structure* — the structural gains require deliberate org design, not just more licenses
- **Tags:** operating-model leadership · change management · workflow redesign · talent & skills · externally cited · supports: the redesign-before-tools thesis, why-licenses-aren't-transformation, workstream sequencing, expectation-setting
- **Principle:** In a 7,137-worker randomized trial, giving people a gen-AI assistant changed *how* existing work got done — fewer, longer focused email sessions, ~2 fewer hours/week in email, less after-hours bleed, more uninterrupted time — but it did **not** change *what* work got done: meeting load, document output, and task mix were unchanged, and spillovers to untreated teammates were essentially zero. The pattern shift "travels with the license, not with the team." The structural changes some expected from AI — fewer meetings, dramatically more output, new kinds of tasks — "do not yet appear when individuals are handed the tool one at a time." What separated firms that shifted from firms that didn't wasn't the tool; it was the unmeasured organizational work — managerial championing, training, deployment strategy.
- **Why it matters:** This is the empirical spine of Stratos's redesign-first thesis. Buying seats recovers individual attention; it does not reorganize the business. Team-level and structural value "will require deliberate organizational design" — team-level rollout, redesigned workflows, and change management — "not just team-level licenses." Use it to set expectations (don't promise structural transformation from a license rollout) and to justify the engagement (the value is in the redesign, which the tool alone won't produce).
- **Quotable line:** "Individual access to generative AI changes the texture of knowledge work — fewer interruptions, less after-hours email, more focused time — without yet changing its structure. The structural [shifts], if they come, will require deliberate organizational design."
...
- **Credibility:** Tier 2 — multi-firm field RCT, NBER (refereed). Disclosed Microsoft author affiliation, full author discretion over results. **VENDOR-TOOL-SPECIFIC source (M365 Copilot) — the principle is tool-agnostic; de-vendor before client use.**
- **Verification:** Reader relay read in full; NBER primary verified 2026-06-29; full PDF not opened this pass.
- **Cross-link:** the benchmark is [[ab-151]]; the capability-not-tools argument is [[pg-122]]; the people-set-the-pace principle is [[pg-21]]; the "fund the production layer 3:1" principle on change-management spend is in the McKinsey change-management entry; the Word-pace evidence is [[ab-150]].
- **Added:** 2026-06-29

### [PG-126] — Stop using AI to do what humans already do well; the payoff is scaling insight, accelerating iteration, exploring without fear, and externalizing expertise — the difference between automation and transformation
- **Tags:** operating-model leadership · AI-forward culture · strategic capacity · externally cited · supports: the transformation-value narrative (beyond expense reduction), the Strategic Moment, reframing AI as more than a faster human
- **Principle:** Treating AI as "like a person" minimizes what's uniquely human and shrinks the imagination about how to use it. AI differs from human intelligence on five axes — scale of intelligence (aggregate insight across hundreds of inputs), speed of ideas (instant first draft and first review), continuity of interaction (no penalty to starting fresh — model many futures), externalization of cognition (reasoning becomes visible, portable, reusable — prompts and workflows pass between people), and ownership of outcomes (AI can act boldly at scale but "has no skin in the game," so human accountability and guardrails matter). The leadership move is to design work around those differences rather than pointing AI at tasks humans already do well.
- **Why it matters:** Reframes the value story away from "AI as a cheaper worker" (expense reduction) toward "AI as a new layer of organizational cognition" (capability the operating model didn't have) — which is the transformation-value section's whole job. Also seats human oversight correctly: the risk isn't wrong answers, it's no ownership, so decisions need clear human accountability.
- **Quotable line:** "So stop using AI to do the things humans already do well, and start using it to scale insight, accelerate iteration, explore without fear, and externalize expertise… The answer just might be the difference between automation and transformation." — Jaime Teevan, Chief Scientist, Microsoft
- **Primary source:** Jaime Teevan (Chief Scientist, Microsoft) — "AI Isn't Human," The New Future of Work Reader (Microsoft) · https://microsoft.github.io/nfw-reader/posts/ai-isnt-human · 2026-05
- **Credibility:** Tier 3 — named senior-practitioner POV (Microsoft Chief Scientist); a framing essay, not a study (its one datum is Miller's 7±2, decades-old). **Source is a tool vendor's chief scientist — the framing is vendor-neutral; attribute honestly and frame for the client.**
- **Verification:** essay read in full 2026-06-29.
- **Cross-link:** the augmentation-not-automation usage evidence is [[ab-152]]; the "AI as new cognition layer / externalize expertise" pairs with the operating-model-shift principles; ownership/guardrails relate to the agentic-governance principle [[pg-118]].
- **Added:** 2026-06-29

### [PG-127] — In AI-assisted work the unit of accountability is no longer the task — it's the conversation; the capability gap is closing faster than the legibility gap
- **Tags:** governance · operating-model leadership · risk & trust · change management · externally cited · supports: AI governance/measurement design, the Evaluation discipline, why-track-the-conversation, oversight framing
- **Principle:** Enterprise AI assistants do more than users explicitly ask — ~3.26 work activities performed per conversation vs ~1.68 requested. Workers see the request and the outcome but "not always the full chain of activities that connects the two." That breaks task-level accountability: you can't attribute an outcome or evaluate the person who prompted it from a request that tells half the story. Whether the AI is "exceeding" the request or "decomposing" it, the consequence is the same — the conversation, not the task, becomes the unit of accountability. The capability gap (what AI can do) is closing on its own; the **legibility gap** (the distance between what workers think happened and what actually happened) is the one still open — and closing it is mostly a matter of making the AI's side of the work visible to the worker and to whoever manages the work.
- **Why it matters:** Most enterprise AI measurement tracks usage (returns, time-on-tool); few track the gap between what a worker set out to do and everything the conversation did to get there. For a FlightPlan's governance and Evaluation design, this says: instrument the conversation, make the AI's actions auditable/attributable/correctable, and don't mistake adoption metrics for accountability.
- **Quotable line:** "The unit of accountability in AI-assisted work is no longer the task — it's the conversation." / "The capability gap is closing on its own. The legibility gap is the one still open."
- **Primary source:** Scott Counts, Andrey Zaikin, Alexia Cambon, Alex Farach — "Beyond the Prompt: Is AI doing more than we ask, or decomposing what we mean?," The New Future of Work Reader (Microsoft) · https://microsoft.github.io/nfw-reader/posts/beyond-the-ask · 2026-06 (interpreting Counts et al., arXiv:2605.23958)
- **Credibility:** Tier 3 — Microsoft researchers' interpretive essay on a Microsoft telemetry study; the 3.26/1.68 figures are Tier-3 vendor-conducted data ([[ab-152]]). **VENDOR-TOOL-SPECIFIC (M365 Copilot Chat) — the accountability principle is tool-agnostic; de-vendor before client use.**
- **Verification:** essay read in full 2026-06-29; underlying paper abstract verified (arXiv:2605.23958).
- **Cross-link:** the data is [[ab-152]]; the marketing-side legibility principle is [[pg-82]]; agentic governance is [[pg-118]]; augmentation framing [[pg-126]].
- **Added:** 2026-06-29

### [PG-128] — How people use AI matters as much as whether they have it: mandating a rigid AI workflow can backfire, while reframing AI as a thought partner (and staging adoption) helps — fix mindset before redesigning the work
- **Tags:** change management · adoption · AI-forward culture · talent & skills · externally cited · supports: enablement design, adoption-mindset coaching, the educate-coach-lead narrative, why-not-to-mandate-a-rigid-process
- **Principle:** In a field experiment with 388 employees at a Fortune 500 retailer (Gap Inc.), everyone had the same AI tool; only the structure around its use varied. A **mandated** "AI-first" collaborative protocol produced *worse* outcomes — documents scored ~5 points lower and treatment pairs were >8× more likely to produce nothing at all (27% produced no document vs 4% of controls) — while light **cognitive** reframing (training that positioned AI as a "thought partner" rather than a feature set) roughly doubled the odds of a top-quality document (OR=2.07; ~62→77 per 100 clearing the bar). The researchers are explicit that the positive result is exploratory (the pre-specified continuous model was null; single-day; design confounds). The durable lessons are directional: forcing a rigid AI process creates friction that suppresses output; absent intentional design people "parallel play" with their own assistant (a *social-placebo* that feels collaborative but changes nothing); and "before redesigning how employees work with AI, organizations may benefit from addressing how employees think about it." Gap frames its own sequence as **Enable → Optimize → Reinvent**: "you don't reinvent the business with AI overnight — you enable the people, optimize the work, and only then scale transformation."
- **Why it matters:** Direct support for Stratos's enablement and change-management design: adoption is a mindset-and-scaffolding problem, not a license problem, and heavy-handed mandates can destroy the value they're meant to create. The Enable/Optimize/Reinvent staging echoes the redesign-first, phased-Wave approach.
- **Quotable line:** "When we stop treating AI like a tool and start treating it like a teammate, we unlock its real potential." — Conor Grennan (CEO, AI Mindset; former Chief AI Architect, NYU Stern). / "You don't reinvent the business with AI overnight — you enable the people, optimize the work, and only then scale transformation." — Sven Gerjets, CTO, Gap Inc.
- **Primary source:** Alex Farach, Alexia Cambon, Lev Tankelevitch, Connie Hsueh, Rebecca Janssen — "Scaffolding Human-AI Collaboration: A Field Experiment on Behavioral Protocols and Cognitive Reframing," arXiv:2604.08678 · https://arxiv.org/abs/2604.08678 · 2026-04 (relayed by The New Future of Work Reader · https://microsoft.github.io/nfw-reader/posts/ai-mindset-experiment)
- **Credibility:** Tier 3 — vendor-conducted exploratory field experiment (Microsoft Research; tool = Microsoft Copilot). Authors disclose null continuous model + design confounds (AM/PM, attrition, LLM grading sensitivity to length). Treat the *direction* (mandates backfire; mindset/scaffolding helps) as the durable signal; treat the point estimates (OR=2.07, ~15pp) as suggestive, not load-bearing. **VENDOR-TOOL-SPECIFIC — de-vendor before client use.**
- **Verification:** Reader relay read in full 2026-06-29; arXiv:2604.08678 (v2) abstract & authors verified (abstract independently confirms the directional findings and the design limitations).
- **Cross-link:** the texture-not-structure RCT is [[pg-125]]; the capability-not-tools principle is [[pg-122]]; people-set-the-pace [[pg-21]]. **Gap Inc. is a study setting, not a peer story — routed to Radar as an `attestation_only` M365 Copilot customer (see ingest notes).**
- **Added:** 2026-06-29

### Notes on the 2026-06-29 Microsoft New Future of Work Reader ingest — AB-150–152, AB-07 (updated), PG-125–128
- Source: Microsoft's **New Future of Work Reader** (https://microsoft.github.io/nfw-reader/), a research hub of controlled studies on AI's impact on work. Six articles read in full (one by me, five via extraction subagents). Each Reader article **relays an underlying paper**; primaries traced and verified 2026-06-29: NBER w33795 (Dillon et al.), arXiv:2605.23958 (Counts et al.), arXiv:2604.08678 (Farach et al.). The two telemetry data-stories (Word pace; usage) are Reader originals (Microsoft) → Tier 3.
- **Operator directive applied:** every entry references Microsoft 365 Copilot specifically, which is **a named vendor tool and not in line with Stratos's vendor-neutral thought.** All entries carry a **VENDOR-TOOL-SPECIFIC · de-vendor-before-client-use** flag; the underlying findings are usable as evidence but must be reframed generically (e.g. "an integrated gen-AI assistant") for the client — never as a Microsoft endorsement.
- **Split by content:** B = [[ab-150]] Word pace −40–45%; [[ab-151]] the 7,137-worker rhythm-not-volume RCT (NBER); [[ab-152]] ~5.5M-session usage + the 3.26-vs-1.68 gap (augmentation-not-automation). [[ab-07]] updated with a cross-link to the expanded RCT (and the doc-speed tension flagged). C = [[pg-125]] texture-not-structure (the redesign-first spine); [[pg-126]] AI-isn't-human / automation-vs-transformation (Teevan); [[pg-127]] conversation-as-unit-of-accountability + legibility gap; [[pg-128]] mindset/scaffolding > access, mandates backfire (Gap/Farach).
- **Tiering note:** the NBER RCT ([[ab-151]]/[[pg-125]]) is Tier 2 (independent refereed venue, disclosed Microsoft affiliation with full author discretion); everything else is Tier 3 (vendor-conducted, research-grade method noted per entry). Lead the FlightPlan with the NBER RCT; the rest corroborates with the vendor caveat captioned.
- **Routed out / to Radar:** **Gap Inc.** is named as a Copilot customer but with no business outcome (study setting only) → **not a Library A peer story**; route to **Radar as `attestation_only` customer of Microsoft 365 Copilot** (via `/radar-ingest`). No Library A entries this ingest (the studies name no transformed company). No partner *capability* ingested here (Copilot capability, if wanted, routes to Radar separately).
- **Strong Stratos alignment** (flag for FlightPlan/marketing): the corpus independently restates the house thesis — tools alone change texture not structure ([[pg-125]]); how-you-use-it beats whether-you-have-it and rigid mandates backfire ([[pg-128]]); value is augmentation/new-cognition, not headcount ([[pg-126]], [[ab-152]]); and the legibility/accountability gap is a governance design problem ([[pg-127]]). Prime corroboration for the redesign-first Strategic Moment and the workforce-enablement narrative.

### [PG-129] — The fastest path to AI adoption is to find the people already succeeding and spread their patterns — stop teaching, start listening
- **Tags:** change management · adoption · talent & skills · AI-forward culture · externally cited · supports: enablement design, the educate-coach-lead narrative, workforce-enablement, shadow-AI→strategy
- **Principle:** Most organizations respond to weak AI adoption by doubling down on training. The higher-leverage move is the opposite: survey the workforce, find the minority already using AI exceptionally (Logitech found **112 "hidden champions" among 7,000 employees**), reverse-engineer *how they think* rather than what they build, codify it, and spread it through rituals and infrastructure. The core insight those champions shared: gen AI is **not a vending machine** (ask once, get an answer, leave — the muscle memory Google trained into us); it's a **thinking partner** that rewards iteration and meta-prompting ("measure twice, cut once" — using AI to improve your prompt before you run it). Two structural barriers otherwise kill adoption: **friction** (if AI is more than "zero clicks away," people won't use it) and **institutional amnesia** (an assistant that forgets context between conversations — treat it as a persistent team member, set up memory and context).
- **Why it matters:** Reframes enablement from a top-down curriculum into a discover-and-amplify program — cheaper, faster, and culturally stickier — and gives the FlightPlan a concrete enablement design: find the champions, codify their patterns, remove friction, build persistent context. Directly supports Stratos's "find what already works, then redesign" approach and the shadow-AI→strategy move.
- **Quotable line:** "Stop teaching. Start listening. The champions are already in your organization. Your job is to find them, learn from them, and help their patterns spread." / "Most people treat AI like a vending machine. It's a thinking partner." — Eric Porres, Chief AI Officer, Logitech
- **Primary source:** Alaura Weaver — "From vending machines to champions: Eric Porres, Logitech's Head of AI," WRITER *Humans of AI* · https://writer.com/blog/humans-of-ai-eric-porres/ · 2026-01-28 (quoting Eric Porres); corroborated by Porres's own *Beyond Reason* (Substack)
- **Found via:** porres.com → WRITER profile / *Beyond Reason* · 2026-06-29
- **Credibility:** Tier 3 — named sitting-CAIO practitioner POV, first-hand account. **De-vendor:** the carrying piece is an AI-platform vendor's blog (WRITER); the principle is tool-agnostic.
- **Verification:** both sources read in full 2026-06-29.
- **Cross-link:** the Logitech story is [[ps-92]]; mindset-over-access is [[pg-128]]; leadership-modeling is [[pg-130]]; people-set-the-pace [[pg-21]]; capability-not-tools [[pg-122]].
- **Added:** 2026-06-29

### [PG-130] — Leadership modeling beats training: training provides knowledge, modeling provides permission — the only adoption strategy that scales is leaders visibly using AI in their own work
- **Tags:** change management · operating-model leadership · AI-forward culture · externally cited · supports: leadership-engagement section, change-management narrative, executive-urgency framing
- **Principle:** Adoption sticks when leaders visibly use AI in their *actual* work, not when they endorse it in a deck. "Do as I do," not "do as I say." Logitech operationalizes this with a ritual: every leadership meeting opens — before the agenda — with one question, "How has AI affected you personally or professionally in the past week?" The ritual signals that AI is how leadership operates, not a project for the innovation team or IT, and shifts what employees treat as optional vs. essential. The companion discipline: "practice makes permanent" — whatever pattern an organization practices (vending-machine vs. iteration) becomes the permanent one, so leaders must model the right pattern.
- **Why it matters:** A concrete, copyable change-management mechanism for the FlightPlan's leadership-engagement section — the people-side lever that converts tool access into culture. Pairs with the fund-the-people-side and culture principles.
- **Quotable line:** "Being the role model for what you want to inspire in others is… the only way it works. It has to work from the top down." / Every leadership meeting opens with: "How has AI affected you personally or professionally in the past week?" — Eric Porres, Chief AI Officer, Logitech
- **Primary source:** Alaura Weaver — "From vending machines to champions: Eric Porres, Logitech's Head of AI," WRITER *Humans of AI* · https://writer.com/blog/humans-of-ai-eric-porres/ · 2026-01-28 (quoting Eric Porres)
- **Found via:** porres.com → WRITER profile · 2026-06-29
- **Credibility:** Tier 3 — named sitting-CAIO practitioner POV. **De-vendor** (vendor-blog carrier; principle is tool-agnostic).
- **Verification:** read in full 2026-06-29.
- **Cross-link:** the Logitech story is [[ps-92]]; champion-led adoption is [[pg-129]]; leaders-model-it echoes the well-being-culture leadership principle but here it is AI-specific.
- **Added:** 2026-06-29

### Notes on the 2026-06-29 Eric Porres / Logitech ingest — PS-92, PG-129, PG-130
- Operator likes Eric Porres's voice (sharp, declarative, "with receipts") and asked whether he's sourceable. **Yes** — beyond his landing pages (which are positioning + an AI-literacy explainer, not evidence), his *Beyond Reason* Substack and a corroborating WRITER *Humans of AI* profile carry a genuine named-company transformation and quotable adoption principles.
- **Sources:** Eric Porres (Chief AI Officer, Logitech), "The Blank Page Is Not Deep Work," *Beyond Reason*, 2026-03-31 (first-hand Logitech metrics + the retrieval-not-generation reframe); Alaura Weaver, "From vending machines to champions," WRITER, 2026-01-28 (the champion-led method, the six-element framework, leadership-modeling ritual). Both read in full 2026-06-29.
- **Split:** A = [[ps-92]] Logitech (CAIO-led, champion-driven enablement; 85% certified / 95%+ active / ~2,000 custom assistants). C = [[pg-129]] champion-led adoption / vending-machine→thinking-partner / friction + institutional-amnesia barriers; [[pg-130]] leadership-modeling-beats-training. All Tier 3 (named-practitioner POV, self-reported metrics) and **de-vendored** (WRITER is a vendor blog; Logitech's stack names Gemini + an internal platform — cite approach/outcomes, never as a tool endorsement).
- **Held back (available to add on request, not ingested to keep signal tight):** the "bottleneck is retrieval, not generation" knowledge-work reframe and the "third position — AI is something you act *with*, value ∝ context + infrastructure you build" framing (both from the Blank Page essay); his other essays ("Skills are the new software," "Claude Cowork…", "The $23 Trillion Blind Spot" — which may carry a Library B benchmark on AI exposure weighted by economic value) were not read this pass.
- **No Radar routing** (no partner capability or net-new customer attribution beyond tool mentions already implicit; Logitech's Gemini/WRITER usage could be logged as Radar attestations if wanted).
